...
static void begin_interactive(struct Toplevel *toplevel,
...
Server::Server(const char* startup_cmd) {
	...
	new_xdg_toplevel.notify = [](struct wl_listener *listener, void *data) {
		...
		struct Toplevel *toplevel = new Toplevel;
		...
		toplevel->request_move.notify = [](struct wl_listener *listener, void *data) {
		...
		toplevel->request_resize.notify = [](struct wl_listener *listener, void *data) {
			/* This event is raised when a client would like to begin an interactive
		...
		toplevel->request_maximize.notify = [](struct wl_listener *listener, void *data) {
		...
		toplevel->request_fullscreen.notify = [](struct wl_listener *listener, void *data) {

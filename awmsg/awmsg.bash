...
_awmsg () {
    ...
    declare -a literals=(list ::= help exit output workspace toplevel)
    declare -a regexes=()
    declare -A literal_transitions=()
    declare -A nontail_transitions=()
    literal_transitions[0]="([3]=2 [4]=2 [5]=2 [6]=2)"
    literal_transitions[1]="([0]=3)"
    literal_transitions[4]="([1]=5)"
    literal_transitions[5]="([2]=2)"
    ...
    declare -A literal_transitions_level_0=([5]="2" [4]="1" [0]="3 4 5 6" [1]="0")

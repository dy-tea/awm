...
_awmsg () {
    ...
    descriptions[18]="list workspaces"
    descriptions[19]="set current workspace to num"
    descriptions[21]="list toplevels"
    descriptions[23]="list keyboards"
    descriptions[25]="list devices"
    descriptions[26]="show current device"
    descriptions[28]="list key bindings"
    descriptions[29]="run key binding for name"
    descriptions[30]="do nothing"
    descriptions[31]="maximize the active window"
    descriptions[32]="fullscreen the active window"
    descriptions[33]="focus the previous window"
    descriptions[34]="focus the next window"
    descriptions[35]="start an interactive move with the active window"
    descriptions[36]="focus the window in the up direction"
    descriptions[37]="focus the window in the down direction"
    descriptions[38]="focus the window in the left direction"
    descriptions[39]="focus the window in the right direction"
    descriptions[40]="close the active window"
    descriptions[41]="swap the active window with the window in the up direction"
    descriptions[42]="swap the active window with the window in the down direction"
    descriptions[43]="swap the active window with the window in the left direction"
    descriptions[44]="swap the active window with the window in the right direction"
    descriptions[45]="half the active window in the up direction"
    descriptions[46]="half the active window in the down direction"
    descriptions[47]="half the active window in the left direction"
    descriptions[48]="half the active window in the right direction"
    descriptions[49]="tile all windows in the active workspace"
    descriptions[50]="tile all windows in the active workspace excluding the active one"
